...
useTitle( movie ? `${movie.title} / Cinemate` :"Loading.....");
  return (
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <div class="flex items-center">
            ...
            <a href="javascript:void(0)" className=" text-gray-900   dark:text-white">{movie.vote_count} reviews</a>
          </div>
          {movie ? (
          <p className="my-4">
          ...
          <p className="my-4">
            ...
            <span><a href={`https:/www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreferrer">{movie.imdb_id}</a></span>
          </p>

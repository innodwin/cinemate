    ...
    <main>
      <section className="max-w-7xl mx-auto py-7">
        ...
        {movies.length > 0 ?"":(
            ...
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white opacity-20">Cinemate Portal</h5>
            <p className="font-normal text-gray-700 dark:text-gray-400 opacity-20">Loading data please wait</p>
